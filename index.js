...
const configs = {
	...
	webhook_url: 'http://domainmu/filewebhook/webhook.php',
	webhook_group: 'http://domainmu/filewebhook/hookgroup.php',
	callback_url: 'http://domainmu/callback.php' // webhook url
};
